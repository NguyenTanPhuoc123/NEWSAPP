...
class _HomeScreenState extends State<HomeScreen> {
  List<News> listNews = List.filled(
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                ...
                icon: const Icon(
                  Icons.search,
                  color: Color.fromRGBO(85, 80, 80, 1),
                ))
=======
      appBar: AppBar(
        // cập nhập thay đổi 
...
>>>>>>> 46716e85d9155ec0407f32edc55fb4456c3e975a
          ],
        ),
        body: SingleChildScrollView(
          child: Column(
                        ...
                        GestureDetector(
                          onTap: () {
                            setState(() {
                              currentPage = index;
                              listNews.clear();
                              ControllerNews.getListNews(categorys[index].url)
                                  .then((value) {
                                setState(() {
                                  listNews = ControllerNews.listNews;
                                });
                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  color: index == currentPage
                                      ? const Color.fromRGBO(52, 221, 99, 0.4)
                                      : Colors.grey[100],
                                  borderRadius: BorderRadius.circular(20),
                                  border: Border.all(
                              ...
                              child: Center(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      color: index == currentPage
                                          ? const Color.fromRGBO(77, 180, 60, 1)
                                          : Colors.black,
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600),
                                ),
